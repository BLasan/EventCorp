        ...
        if(doc){
            ...
            get_receiver_details(searched_user,database,function(docs){
                if(docs){
                    ...
                    var receiver_email=docs.email;
                    var receiver_role=docs.role;
                    var sender_data={receiver_email:receiver_email,receiver_id:searched_user,receiver_name:docs.user_name,receiver_role:receiver_role,time:time,status:'Pending',view:false};
